...
import mec.mec.excel16.adapter.ScheduleEventsAdapter;
...
//            Call<ArrayList<ScheduleEvent>> call = api.getScheduleOne();
    ...
    private boolean retrieveScheduleEventsData() {
        Gson gson = new Gson();
        String json = mPrefs.getString("ScheduleEventsList"+dayNum, "");
        if (!json.isEmpty()) {
    ...
    private void saveScheduleEventsData() {
        ...
        prefsEditor.putString("ScheduleEventsList" + dayNum, json);
        prefsEditor.apply();
    }
